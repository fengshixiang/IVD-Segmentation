...
class Parameter(object):
    def __init__(self): 
        ...
        self.root_address = '/DATA5_DB8/data/sxfeng/data/IVDNet/experiment/010611_4'
        self.cost = 'shape_5' #name of the cost function. cross_entropy , dice, shape
        ...
        self.dropout=1.0
        self.restore=True       #Flag if previous model should be restored
