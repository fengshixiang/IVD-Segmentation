...
data_save_address = '/DATA5_DB8/data/sxfeng/data/IVDM3Seg/2D_data/2.5D_12_data' 
start_index = 0
end_index = 36
...
for addr in os.listdir(npy_data_address):
    ...
    for index in range(start_index, end_index):
        ...
        if index==start_index:
            ...
            fat_image_arr_5.append(fat_voxel_arr[index+1])
            inn_image_arr_5.append(inn_voxel_arr[index+1])
            opp_image_arr_5.append(opp_voxel_arr[index+1])
            wat_image_arr_5.append(wat_voxel_arr[index+1])
